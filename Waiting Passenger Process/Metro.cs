...
//Powolanie parametrow dla klasy Metro - Punkt w Scorecard: Atrybuty własne
[Parameters("Metro.txt", "Metro", 'M')]

//Polimorfizm, Dziedziczenie klas - Punkt w Scorecard: Polimorfizm
public class Metro : MeansOfTransport
{
    //Pobranie atrybutow dla klasy Metro - Punkt w Scorecard: Atrybuty własne
    static Parameters parameters = (Parameters)Attribute.GetCustomAttribute(typeof(Metro), typeof(Parameters));
