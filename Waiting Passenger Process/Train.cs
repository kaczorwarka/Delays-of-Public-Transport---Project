...
//Powolanie parametrow dla klasy Train - Punkt w Scorecard: Atrybuty własne
[Parameters("Train.txt", "Train", 'P')]

//Polimorfizm, Dziedziczenie klas - Punkt w Scorecard: Polimorfizm
public class Train : MeansOfTransport
{
    //Pobranie atrybutow dla klasy Train - Punkt w Scorecard: Atrybuty własne
    static Parameters parameters = (Parameters)Attribute.GetCustomAttribute(typeof(Train), typeof(Parameters));
